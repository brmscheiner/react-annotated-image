...
function App() {
  ...
  return (
    <div className="App">
      ...
      {Boolean(imgSrc) && (
        <AnnotatedImage src={imgSrc} createMode={createMode} rects={rects} onCreateRect={(_, allRects) => setRects(allRects)} lines={lines} onCreateLine={(_, allLines) => setLines(allLines)} width={800} />
      )}
