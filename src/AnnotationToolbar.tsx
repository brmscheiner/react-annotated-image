...
export default function AnnotationToolbar(props: AnnotationToolbarProps): JSX.Element {
  ...
  return <div>
    <button style={createMode === CreateMode.Rect ? activeStyles : inactiveStyles} onClick={(e) => {
    ...
    <button style={createMode === CreateMode.Line ? activeStyles : inactiveStyles}  onClick={() => {
